...
for i in range (2, len(network_add['A'])+1):
    network_details = {
                    ...
                    "networkTemplateConfig": "{\"gatewayIpAddress\":\"\",\"gatewayIpV6Address\":\"\",\"vlanName\":\"\",\"intfDescription\":\"\",\"mtu\":\"9216\",\"secondaryGW1\":\"\",\"secondaryGW2\":\"\",\"secondaryGW3\":\"\",\"secondaryGW4\":\"\",\"suppressArp\":false,\"enableIR\":false,\"trmEnabled\":false,\"rtBothAuto\":true,\"enableL3OnBorder\":false,\"mcastGroup\":\""+str(network_add[f'E{i}'].value)+"\",\"dhcpServerAddr1\":\"\",\"vrfDhcp\":\"\",\"dhcpServerAddr2\":\"\",\"vrfDhcp2\":\"\",\"dhcpServerAddr3\":\"\",\"vrfDhcp3\":\"\",\"loopbackId\":\"\",\"tag\":\"12345\",\"vrfName\":\"NA\",\"isLayer2Only\":true,\"nveId\":1,\"vlanId\":\""+str(network_add[f'F{i}'].value)+"\",\"segmentId\":\""+str(network_add[f'C{i}'].value)+"\",\"networkName\":\""+str(network_add[f'A{i}'].value)+"\"}",
