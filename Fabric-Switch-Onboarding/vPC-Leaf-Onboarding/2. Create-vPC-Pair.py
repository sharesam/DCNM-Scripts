...
wb = load_workbook('/Users/krishna/python-projects/My_venvs/venv1-enterprise/DCNM-Python-Testing/Fabric-Switch-Onboarding/vPC-Leaf-Onboarding/vPC-Leaf-Details.xlsx')
...
vPC_Peering = {"peerOneId":vPC_leaf_onboarding['A2'].value,"peerTwoId":vPC_leaf_onboarding['A3'].value}#"useVirtualPeerlink":'true'}

requests.post(url_vpc_pairing, headers=headers_token, verify=False, data=json.dumps(vPC_Peering)) ####send a request to vPC the leaf pairs
